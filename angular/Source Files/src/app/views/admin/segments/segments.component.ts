...
export class SegmentsComponent implements OnInit {
  ...
  doesSegmentExist(idx: number){
    return this.data.segments[idx].sg_code === this.selectedItem.sg_code && 
    this.data.segments[idx].sg_name === this.selectedItem.sg_name && 
    this.data.segments[idx].sg_parent === this.selectedItem.sg_parent &&
    this.data.segments[idx].sg_type === this.selectedItem.sg_type;
 }
}
